...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData(){ //데이터 등록하기~
        ...
        talkData.Add(4000+80, new string[]{"도굴꾼 : 나랑 거래하나 할래?", "도굴꾼 : 저기 있는 문을 넘어가려면 신기한 돌이 필요해.","도굴꾼 : 황금을 찾으러 왔지만 나한테 쓸모없는 이 돌만 주웠지 뭐야." ,"도굴꾼 : 황금을 가져오면 내가 가지고 있는 돌을 하나 줄게! 싫으면 직접 구하던가~"});
