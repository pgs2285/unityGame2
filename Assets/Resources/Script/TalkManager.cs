...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData(){ //데이터 등록하기~
        ...
        talkData.Add(2000+80 , new string[]{"도굴꾼 : 뭐야 이런곳에 나말고 누군가 있네? 너 용감하구나?","도굴꾼 : 여기 아래는 위험해~ 옆에 포탈을 타고싶으면 특별한 돌이 필요하기도 하지", "도굴꾼 : 돌은 곰들이 가끔 떨구간하는데... 나한테도 하나있어!", "도굴꾼 : 공짜로 줄수는 없고, 이 동굴에 황금이 있다는데 나는 찾기 힘들단 말이야." ,"도굴꾼 : 가져오면 내가 가지고 있는 돌을 하나 줄게! 싫으면 직접 구하던가~"});
