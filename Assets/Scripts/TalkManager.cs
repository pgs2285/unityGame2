...
public class TalkManager : MonoBehaviour
{
    ...
    void GenerateData(){ //데이터 등록하기~
        ...
        talkData.Add(2000 + 60, new string[] { "혼란스럽지?", " 아마 무슨일인가 싶을거야...", "일단 나를 따라와봐.", "지금까지 일어난 일에 대해 설명을 해줄게", "앞으로 쭉가다보면 덩굴이 하나 있을거야..", "내가 임시로 덩굴을 뛰어넘을 수 있는 방법을 하나 알려줄게", "이제부터 스페이스바를 누르면 일정 거리를 뛰어넘을 수 있을거야.", "덩굴 넘어서 보도록하자" });
            ...
            if (talkIndex == talkData[id - id % 10].Length)
            {
                switch (id) // 특정대사가 끝나고 컷신 or 스킬을 넣어주고 싶으면 여기서
                {
                    ...
                    case 2060:
                        ...
                        TutorialMessage.text = "이제부터 Z를 누르면 일정거리를 텔레포트 할 수 있습니다";
